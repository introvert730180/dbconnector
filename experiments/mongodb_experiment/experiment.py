...
if __name__ == "__main__":
    ...
    collection_name2 = "testAbhijeet"
    obj = MongoOperation(client_url, database)
    data = {'name': 'Abhijeetkr.'}
    data2 = {'name': 'Abhijeetkr. ', 'Job': 'Sr.. Data Scientist'} 
    filter = {"name": {"$regex": "Abhijeetkr."}}
    limit=1
    obj.read_data(collection_name)
    # print(obj.delete_data(collection_name,filter))
